...
const featuredProjects: IFeaturedProjects[] = [
	{
		...
		left: true,
		features: [
			"Full responsive app with a mobile-first approach",
			"Loading products from the cloud server with the NoSQL database",
			"Add to wishlist with localhost persistence",
			"Add to cart",
			"Checkout with Stripe payment gateway",
			"User Registration / Login with an email/username",
			"User authentication using JWT token with HTTP-only cookies",
			"Full CRUD operation using Express JS",
			"Protected CROS origins",
			"Demo user login: username: test | password: 123456",
		],
		url: "rey",
	},
	{
