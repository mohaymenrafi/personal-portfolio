  ...
  return (
    <div className="hidden lg:flex fixed bottom-0 right-8 xl:right-12 flex-col items-center gap-5 z-40">
      <a
        ...
        className="text-sideways text-slate hover:text-teal hover:-translate-y-1 transition-all duration-200 font-[family-name:var(--font-sf-mono)] text-xs tracking-widest"
      >
